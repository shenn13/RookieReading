...
- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    UICollectionViewLayoutAttributes *headerAttribute = [self layoutAttributesForSupplementaryViewOfKind:JFHeaderKind atIndexPath:indexPath];
...
- (void)setReusableViewParamsForAttribute:(UICollectionViewLayoutAttributes *)attribute
{
    ...
    attribute.frame = CGRectMake(0, offset_Y, SCREEN_WIDTH, height);
}
